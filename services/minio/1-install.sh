...
helm install minio bitnami/minio --version 17.0.16 --namespace $NS --create-namespace -f values.yaml --set ingress.hostname="s3.$DOMAIN" --set console.ingress.hostname="minio.$DOMAIN"
